...
{
	public static GStruct16[] gstruct16_0 = new GStruct16[518]
	{
		new GStruct16
		{
			int_0 = 0,
	...
	{
		return (int)Class20.smethod_30(Class47.gstruct43_27.uint_0, gstruct42_0.int_130);
	}

	public static string smethod_1(int int_0, bool bool_0 = false)
	{
		for (int i = 0; i < gstruct16_0.GetLength(0); i++)
		{
			if (gstruct16_0[i].int_0 == int_0)
			{
				string string_ = gstruct16_0[i].string_0;
				if (bool_0)
				{
					return Class10.smethod_1(string_, 1);
				}
				return string_;
			}
		}
	...
	{
		if (Class47.gstruct43_28.uint_0 != 0 && Class47.gstruct43_29.uint_0 != 0)
		{
			uint uint_ = gstruct42_0.uint_6 + Class47.gstruct43_28.uint_0 + Class47.gstruct43_29.uint_0;
			return Class20.smethod_28(uint_, gstruct42_0.int_130, 60);
		}
		return "";
	}
}
