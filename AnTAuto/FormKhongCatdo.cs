...
public class FormKhongCatdo : Form
{
		...
		if (bool_0)
		{
			if (int_1 != int_0)
			{
				...
				else
				{
					...
					method_0(FormMain.gstruct42_0[num].string_4);
				}
			}
		}
		else
	...
	private void buttonThem_Click(object sender, EventArgs e)
	{
		...
		if (FormMain.gstruct42_0[num].string_4 != null)
		{
			for (int i = 0; i < FormMain.gstruct42_0[num].string_4.Length; i++)
			{
				if (FormMain.gstruct42_0[num].string_4[i] == text)
				{
					return;
				}
			}
		...
		Class11.smethod_24(ref FormMain.gstruct42_0[num].string_4, text);
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		if (FormMain.gstruct42_0[num].string_4 != null)
		{
			for (i = 0; i < FormMain.gstruct42_0[num].string_4.Length; i++)
			{
				if (Class10.smethod_1(FormMain.gstruct42_0[num].string_4[i], 1) == text)
				{
					Class11.smethod_25(ref FormMain.gstruct42_0[num].string_4, FormMain.gstruct42_0[num].string_4[i]);
					Class47.smethod_11(FormMain.gstruct42_0[num]);
					break;
				}
			}
		...
		if (num >= 0 && FormMain.gstruct42_0 != null)
		{
			try
			{
				for (int i = 0; i < FormMain.gstruct42_0.Length; i++)
				{
					if (i != num)
					{
						FormMain.gstruct42_0[i].string_4 = null;
						if (FormMain.gstruct42_0[num].string_4 != null)
						{
							FormMain.gstruct42_0[i].string_4 = new string[FormMain.gstruct42_0[num].string_4.Length];
							for (int j = 0; j < FormMain.gstruct42_0[num].string_4.Length; j++)
							{
								FormMain.gstruct42_0[i].string_4[j] = FormMain.gstruct42_0[num].string_4[j];
							}
