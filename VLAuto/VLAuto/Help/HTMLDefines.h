...
#define HIDR_EXIT_WAVE                          0x2008B
 
// Dialogs (IDD_*) 
#define HIDD_VLAUTO_DIALOG						0x20066
#define HIDD_BASIC_DIALOG						0x20081
#define HIDD_RECOVER_DIALOG						0x20082
#define HIDD_ATTACK_DIALOG						0x20083
#define HIDD_COLLECT_DIALOG						0x20084
#define HIDD_MOVE_DIALOG						0x20085
#define HIDD_PARTY_DIALOG						0x20086
#define HIDD_MAP_DIALOG							0x20087
#define HIDD_ABOUT_DIALOG						0x20088
#define HIDD_EXIT_DIALOG						0x20089
#define HIDD_OPTION_DIALOG						0x2008D
#define HIDD_LOGIN_DIALOG						0x20093
#define HIDD_YESOU_DIALOG						0x200AA
#define HIDD_PRIZESEL_DIALOG					0x200AB
#define HIDD_BUYITEM_DIALOG						0x200AC
#define HIDD_TUZHI_DIALOG						0x200AD
#define HIDD_ADDPOINT_DIALOG					0x200AE
#define HIDD_UTILITY_DIALOG						0x200AF
#define HIDD_FINDITEM_DIALOG					0x200B0
#define HIDD_TONGQ_DIALOG						0x200B1
#define HIDD_TONGPK_DIALOG						0x200B2
#define HIDD_TONGPKFILTER_DIALOG				0x200B3
