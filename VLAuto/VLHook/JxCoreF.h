...
public:
	...
	int				m_nCurEngergy;
	int				m_nCurLucky;
	__int64			m_nExp;					//0x5768
	__int64			m_nNextLevelExp;
	char			m_PlayerName[40];
	KPlayerTeam		m_cTeam;				//0x57a0
	BYTE			PlayerData4[0x05A8];
	int				m_nCurFaction;
	BYTE			PlayerData5[0x0350];
	int				m_nPKValue;
	KPlayerTong		m_cTong;
	BYTE			PlayerData6[0x2310];
	KPlayerTask		m_cTask;				//0x8480
